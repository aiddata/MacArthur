...
spdf_adm <- spdf_adm[spdf_adm@data$NAME_0 == "Kenya",]
...
locations2 <- locations[grep("Kenya", locations$gazetteer_adm_name),]
...
Mac_spdf <- Mac_prec
#Subset by sector code (all combined social sector projects)
...
writePointsShape(Mac_spdf, "/home/aiddata/Desktop/Github/MacArthur/modelData/Mac_spdf_KenyaSoc.shp")
...
#save (correlogram_data, file="/home/aiddata/Desktop/Github/MacArthur/modelData/kenya_correl.RData")

load("/home/aiddata/Desktop/Github/MacArthur/modelData/kenya_correl.RData")
...
writePolyShape(AOI_cells, "/home/aiddata/Desktop/Github/MacArthur/modelData/AOI_cells_KenyaSoc.shp")
...
TempDF <- cbind.data.frame(record_length, AvgYears, Avg_MinYears, CountProj_Years, Dist_Decay_Yrs)
...
all_reshape <- c(PCloss, mean_ln, minairTemp, maxairTemp, meanairTemp, minPre, maxPre, meanPre, MinDist, DecayDist)
...
write.csv(Panel_Data, "/home/aiddata/Desktop/Github/MacArthur/modelData/kenya_soc.csv")

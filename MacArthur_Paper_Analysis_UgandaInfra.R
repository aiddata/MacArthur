...
spdf_adm <- spdf_adm[spdf_adm@data$NAME_0 == "Uganda",]
...
locations2 <- locations[grep("Uganda", locations$gazetteer_adm_name),]
...
Mac_spdf <- Mac_prec
#Subset by sector code (all combined infrastructure sector projects)
...
writePointsShape(Mac_spdf, "/home/aiddata/Desktop/Github/MacArthur/modelData/Mac_spdf_UgandaInfra.shp")
...
save (correlogram_data, file="/home/aiddata/Desktop/Github/MacArthur/modelData/uganda_correl.RData")
...
writePolyShape(AOI_cells, "/home/aiddata/Desktop/Github/MacArthur/modelData/AOI_cells_UgandaInfra")
...
write.csv(Panel_Data, "/home/aiddata/Desktop/Github/MacArthur/modelData/uganda_infra.csv")

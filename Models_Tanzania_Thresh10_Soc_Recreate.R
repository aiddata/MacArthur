...
write.csv(Mac_spdf@data,"/Users/rbtrichler/Box Sync/MacArthur/Mac_spdf_TanzSoc.csv")
...
thresh_dMatrix[thresh_dMatrix >= 100000] <- NA
...
write.csv(Panel_Data,"/Users/rbtrichler/Box Sync/MacArthur/tanzania_soc_oct2017.csv")
...
pop <- read.csv(paste(active_dir_path,"/GPW4_Extracts/merge_africa_grid.csv",sep=""))
...
#create it in panel form with variable name Pop
...
#   
#   if (substr(colnames(ntl)[i], 1, 4) == "n"){
#     
#     name = "NTL"
